...
- Web Esencial: setecientos noventa euros. Cinco páginas, responsive, SEO básico, lista en siete a diez días. Incluye treinta días de Departamento Lite completamente de regalo. Al entregar se recibe el código fuente completo, es del cliente.
- Web Profesional: desde mil trescientos noventa euros. Diseño a medida, páginas ilimitadas, un chat que responde y agenda citas de fábrica. Entrega en dos a cuatro semanas. Incluye treinta días de Departamento Lite completamente de regalo.
