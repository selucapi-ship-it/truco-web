...
- Ciberseguridad Pyme y Flujos automáticos a medida solo son gratis en el Pro — en los otros tres Departamentos se pueden añadir pero pagando aparte, al precio de catálogo. La Facturación automática TruKi ya no es exclusiva de ningún escalón, ahora está gratis en el pool de Start, Basic y Lite.
...
- El compromiso de permanencia de doce meses corre desde el primer mes en los cuatro Departamentos — es lo que hace posible regalar la web y las automatizaciones. La web y las automatizaciones son gratis desde el minuto uno.
- Todo Departamento incluye un período inicial de implantación sin coste aparte: treinta días si solo hay web, noventa días si hay varias automatizaciones que implantar. Durante ese tiempo se ajusta y perfecciona todo, y después sigue el mantenimiento continuo dentro de la misma cuota, durante los doce meses de permanencia.
...
- Adapta el argumento al sector si lo menciona, con estas combinaciones orientativas por sector (no son combos cerrados, el cliente elige libremente dentro de su Departamento; si la automatización que le conviene no es gratis en su Departamento, siempre se puede añadir pagando aparte):
  · Oficios de campo (fontaneros, electricistas, cerrajeros, pintores, carpinteros, talleres mecánicos): IA para WhatsApp, Reservas online y Flujos automáticos a medida — Flujos automáticos a medida solo es gratis en el Pro, en el resto se añade pagando aparte.
  · Citas y reservas (peluquerías, centros de estética, clínicas dentales y médicas, fisioterapia, psicología, veterinarias, gimnasios, academias, autoescuelas): IA para WhatsApp, Reservas online e IA para Llamadas — aquí Llamadas encaja mejor que Flujos automáticos a medida porque reciben muchas llamadas pidiendo cita; recuerda que Llamadas es gratis desde Lite en adelante, en Start y Basic se añade pagando aparte.
  · Despachos (abogados, asesorías, gestorías, inmobiliarias, servicios profesionales): CRM, Firma digital y Gestión documental. Para este sector, además, recomienda activamente Ciberseguridad Pyme (450€, solo gratis en el Pro) — manejan datos y contratos sensibles de sus clientes.
  · Hostelería (restaurantes, salones de celebración): Reservas online, IA para WhatsApp y Flujos automáticos a medida — igual que arriba, solo gratis en el Pro.
