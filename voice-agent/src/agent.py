...
- Basic: sesenta y nueve euros al mes. Permanencia mínima de seis meses. Sin web. Una solución gratis a elegir entre IA para WhatsApp, Facturación automática TruKi, Reservas y Agenda, o IA para tu Web. Mantiene hasta dos soluciones en total.
...
- Pro: precio estándar quinientos cuarenta y nueve euros al mes. Permanencia mínima de doce meses. Web Profesional más tres soluciones gratis del mismo grupo de ocho que Lite, sin TruKi. Mantiene hasta seis soluciones en total, con supervisión continua, prioridad alta en incidencias con respuesta en menos de veinticuatro horas, y una reunión mensual de cuarenta y cinco minutos.
...
- Si el cliente entra directo al Departamento (Basic, Lite o Pro, sin proyecto previo), el compromiso de permanencia corre desde el primer mes — es lo que hace posible regalar la web y las soluciones. No hay período de regalo aparte en este caso, el regalo es la propia web y las soluciones desde el minuto uno.
- Si el cliente entra por un proyecto (web suelta o Digitaliza), no hay ninguna permanencia en ningún momento. El período de implantación va completamente de regalo: treinta días en proyectos web, con el Departamento Lite de regalo esos treinta días; noventa días en Digitaliza, con el Departamento Lite o Pro de regalo según el número de soluciones. Pasado ese período de regalo, el cliente pasa automáticamente a su Departamento en modo mensual al precio estándar, sin que tenga que hacer nada — si no quiere seguir, cancela avisando con siete días. Aquí no hay ningún compromiso de doce meses, ni aunque continúe.
