...
- Cómo se paga: solo hay dos formas. Pago único con tarjeta, por adelantado de tu primer año, con un doce por ciento de descuento. O con PayPal, mismo importe sin ese descuento — si la cuenta de quien paga es apta, PayPal le puede dejar elegir en su propio proceso de pago fraccionarlo en tres plazos sin intereses, algo entre el cliente y PayPal, a nosotros nos llega igual, de una vez. TRUCO nunca hace facturación mensual directa — es una decisión pensada para no depender de que nadie se acuerde de pagar cada mes.
