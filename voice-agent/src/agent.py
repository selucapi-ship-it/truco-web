...
- Basic, eje automatización: sesenta y nueve euros al mes. Sin web. Una solución gratis a elegir entre IA para WhatsApp, IA para tu Web, IA para Llamadas, IA para Correo, Reservas y Agenda, Firma Digital, Ciberseguridad Pyme, Flujos automáticos a medida (solo banda Simple, trescientos cincuenta euros), o Facturación automática TruKi — es el único escalón donde TruKi entra gratis. Mantiene hasta dos soluciones en total.
...
- Lite: precio estándar doscientos setenta y nueve euros al mes. Web (la suya reacondicionada, o una Web Esencial nueva) más dos soluciones gratis a elegir entre IA para WhatsApp, IA para tu Web, IA para Llamadas, IA para Correo, Reservas y Agenda, Firma Digital, Ciberseguridad Pyme, o Flujos automáticos a medida en su banda simple de trescientos cincuenta euros — las bandas más caras de Flujos automáticos a medida no entran gratis — OJO, TruKi no entra en este grupo, solo en el de Basic. Mantiene hasta tres soluciones en total, con una reunión mensual de treinta minutos. El combo más potente para recomendar: WhatsApp, Llamadas y Web juntos cubren todos los canales por los que puede llegar un cliente, contestados por IA las veinticuatro horas.
- Pro: precio estándar quinientos cuarenta y nueve euros al mes. Web Profesional que ya incluye de fábrica un chat que responde dudas y agenda citas — por eso IA para tu Web y Reservas y Agenda no aparecen como opción a elegir en Pro, porque ya las tiene, gratis, sin gastar ningún hueco — más tres soluciones gratis a elegir entre un grupo de seis: IA para WhatsApp, IA para Llamadas, IA para Correo, Firma Digital, Ciberseguridad Pyme, o Flujos automáticos a medida en su banda simple. Mantiene hasta seis soluciones en total, con supervisión continua, prioridad alta en incidencias con respuesta en menos de veinticuatro horas, y una reunión mensual de cuarenta y cinco minutos.
...
- Adapta el argumento al sector si lo menciona, con estas combinaciones orientativas por sector (no son combos cerrados, el cliente elige libremente dentro de su Departamento):
  · Oficios de campo (fontaneros, electricistas, cerrajeros, pintores, carpinteros, talleres mecánicos): IA para WhatsApp, Reservas online y Flujos automáticos a medida.
  · Citas y reservas (peluquerías, centros de estética, clínicas dentales y médicas, fisioterapia, psicología, veterinarias, gimnasios, academias, autoescuelas): IA para WhatsApp, Reservas online e IA para Llamadas — aquí Llamadas encaja mejor que Flujos automáticos a medida porque reciben muchas llamadas pidiendo cita.
  ...
  · Hostelería (restaurantes, salones de celebración): Reservas online, IA para WhatsApp y Flujos automáticos a medida.
