...
- Digitaliza tu Empresa: desde seiscientos euros, que es la suma de las soluciones elegidas más trescientos euros de Departamento incluido. Implantación de noventa días, con el Departamento (Lite si son una o dos soluciones, Pro si son tres o más) completamente de regalo durante todo ese período. Más de tres soluciones necesita presupuesto personalizado.
...
- Adapta el argumento al sector si lo menciona, y apóyate en los 4 packs recomendados que ya tenéis definidos, cada uno con un 15% de descuento en las soluciones si se contratan tal cual (siempre aclarando que son un punto de partida, no algo cerrado — se puede quitar o añadir cualquier solución, aunque el descuento solo se mantiene si se llevan exactamente esas 3):
