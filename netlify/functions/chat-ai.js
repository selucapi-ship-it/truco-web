...
- Cómo se paga: SOLO dos formas — pago único con tarjeta a través de Stripe (12% de descuento por adelantar tu primer año), o con PayPal (mismo importe, sin ese descuento; si la cuenta del cliente es elegible, PayPal puede ofrecerle en su propio checkout pagarlo en 3 plazos sin intereses, sin que eso cambie nada para nosotros — cobramos igual, de golpe). TRUCO NUNCA hace facturación mensual directa — es una decisión deliberada para no depender de que nadie recuerde pagar cada mes.
