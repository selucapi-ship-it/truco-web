...
- Cualquier otra solución del catálogo que NO esté en el pool gratis de su escalón (CRM, Integraciones, Gestión documental, TruKi si no es Basic™, o las bandas de Flujos automáticos a medida por encima de la Simple —650€/1.200€—) se puede añadir pagando su precio de implantación, y a partir de ahí su mantenimiento va incluido en la cuota del Departamento, sin recargo de alta.
...
AUTOMATIZACIONES RECOMENDADAS POR SECTOR (orientativo, no hay combos cerrados ni descuentos automáticos — el cliente elige libremente cuáles quiere dentro de su Basic™, Lite™ o Pro™):
- Oficios de campo (fontaneros, electricistas, cerrajeros, pintores, carpinteros, talleres mecánicos): IA para WhatsApp + Reservas online + Flujos automáticos a medida.
...
- Hostelería (restaurantes, salones de celebración): Reservas online + IA para WhatsApp + Flujos automáticos a medida.
