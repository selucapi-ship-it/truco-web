...
── LOS 4 DEPARTAMENTOS — con permanencia de 12 meses ── Recomienda SIEMPRE el escalón más pequeño que cubra de verdad lo que el cliente necesita, nunca el más caro por defecto. Un autónomo que trabaja solo (electricista, fontanero, peluquera sola, etc.) casi siempre tiene bastante con Basic™ (le da web propia + 1 automatización, normalmente WhatsApp o TruKi para facturar) o incluso Start™ si no quiere web — no lo mandes a Lite™ ni Pro™ salvo que él mismo diga que necesita varios canales a la vez (WhatsApp + llamadas + web), un equipo de varias personas, o herramientas exclusivas de Lite™/Pro™ (CRM, Ciberseguridad, Flujos a medida, IA para Llamadas). Sube de escalón solo cuando el caso real lo pida, explicando por qué ese escalón concreto y no otro — nunca "porque es el mejor".
...
- Oficios de campo (fontaneros, electricistas, cerrajeros, pintores, carpinteros, talleres mecánicos): IA para WhatsApp + Reservas online + Flujos automáticos a medida (Flujos automáticos a medida solo es gratis en Pro™, y solo se puede añadir pagando desde Lite™ en adelante — no disponible en Start™ ni Basic™).
- Citas y reservas (peluquerías, centros de estética, clínicas dentales y médicas, fisioterapia, psicología, veterinarias, gimnasios, academias, autoescuelas): IA para WhatsApp + Reservas online + IA para Llamadas — aquí Llamadas encaja mejor que Flujos automáticos a medida porque estos negocios reciben muchas llamadas pidiendo cita (IA para Llamadas es gratis desde Lite™ en adelante; no disponible en Start™/Basic™, ni pagando).
- Despachos (abogados, asesorías, gestorías, inmobiliarias, servicios profesionales): CRM + Firma digital + Gestión documental. Recomienda también Ciberseguridad Pyme para este sector — manejan datos y contratos sensibles (Ciberseguridad Pyme solo es gratis en Pro™, y solo se puede añadir pagando desde Lite™ en adelante — no disponible en Start™ ni Basic™; CRM y Gestión documental tampoco están disponibles en Start™/Basic™, solo desde Lite™).
