...
- Cómo se paga: SOLO dos formas — pago único con tarjeta a través de Stripe (12% de descuento por adelantar tu primer año), o con PayPal (mismo importe y el mismo 12% de descuento; si PayPal se lo ofrece, el cliente puede fraccionar el pago en el checkout de PayPal: «Paga en 3 plazos» de 20 € a 2.000 € sin intereses durante 2 meses, o «Paga en 6, 12 o 24 plazos» de 120 € a 5.000 € con los intereses que fija PayPal. La aprobación y las condiciones son solo de PayPal, no prometas que se lo darán ni des importes exactos de cuotas; a nosotros nos llega el total de golpe). TRUCO NUNCA hace facturación mensual directa — es una decisión deliberada para no depender de que nadie recuerde pagar cada mes.
...
- Hostelería (restaurantes, salones de celebración): por defecto, IA para WhatsApp — con Basic™ ya cubre reservas de mesa sin llamadas perdidas (la web ya trae agenda con citas online). Solo menciona Flujos automáticos a medida (confirmaciones y recordatorios automáticos) como upgrade si el cliente dice explícitamente que los no-shows son un problema grande; exclusiva desde Lite™ en adelante, no la ofrezcas por defecto.
Si el negocio no encaja en ninguno de estos 4 (comercio/tienda, ecommerce, u "otro"), recomienda combinar las automatizaciones que encajen (normalmente CRM + Flujos automáticos a medida + Integraciones para comercio, más Ciberseguridad Pyme si manejan datos sensibles) y que elija directamente del catálogo completo en servicios.html#automatizaciones.
